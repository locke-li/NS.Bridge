...
namespace ProtokitHelper
{
    public class ProtokitUtil : Singleton<ProtokitUtil>
    {
        ...
        private void InitHttpCommonHeader()
        {
            httpHeader.Clear();
        ...
        private void InitProtoParser()
        {
            ...
            foreach (var asm in assemble)
            {
                ...
                if (asmName.Equals("GoogleProtobuf") || asmName.StartsWith("UnityEngine") || asmName.StartsWith("UnityEditor")) continue;
                foreach (var t in asm.GetTypes())
                {
                    ...
                    //UnityEngine.Debug.Log("add parser:" + p.Descriptor.FullName + ", type full name:" + typeFullName);
                }
            }
        }
        ...
        public RawProto GetRawPorto(IMessage msg)
        {
            using (var stream = new MemoryStream())
            {
                ...
                var rawProto = new RawProto
                {
                    ...
                    ProtoLog = $"name:{msg.Descriptor.FullName}, body:{msg}"
                };
                return rawProto;
            }
        }
